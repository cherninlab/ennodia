...
Experimental local Hypertext Transfer Protocol (HTTP) surface for Ennodia.

Install and run it separately from the core Model Context Protocol (MCP)
package:

```sh
bunx @cherninlab/ennodia-io
```
