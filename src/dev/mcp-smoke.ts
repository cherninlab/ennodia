...
assertIncludes(toolNames, "ennodia_start_plan_advice");
assertIncludes(toolNames, "ennodia_list_plan_advice");
assertIncludes(toolNames, "ennodia_get_plan_advice");
assertIncludes(toolNames, "ennodia_cancel_plan_advice");
assertIncludes(toolNames, "ennodia_start_advised_plan");
